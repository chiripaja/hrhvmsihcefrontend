...
export const ModalGenerico = ({ isOpen, onClose, children }:any) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-white rounded-lg shadow-lg max-w-[95vw] w-full h-full border-sky-500 border-4 p-4 relative overflow-y-auto max-h-[95vh] transition-transform duration-300 transform ${isOpen ? 'scale-100' : 'scale-95'}`}
      >
        <button

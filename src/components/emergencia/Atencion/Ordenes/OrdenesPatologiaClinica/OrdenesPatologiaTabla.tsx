...
export const OrdenesPatologiaTabla = ({ modificar = 0,datosEmergencia ,recetaIdTemporal}:
  ...
  <div className="max-h-[300px] overflow-x-hidden overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
      ...
      <table className={datosEmergencia?.ordenesPatologiaClinica.length > 0 ? "tableT" : "hidden"} >
          <thead>
              <tr>
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
              ...
              {datosEmergencia?.ordenesPatologiaClinica.filter((data:any)=>data.idrecetacabecera==recetaIdTemporal).map((data: any,index:any) => (

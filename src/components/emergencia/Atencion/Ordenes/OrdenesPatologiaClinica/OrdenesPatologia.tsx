...
import { OrdenesPatologiaTablaRecetasCabecera } from './OrdenesPatologiaTablaRecetasCabecera';
import { CgAdd } from 'react-icons/cg';
import { OrdenesPatologiaTabla } from './OrdenesPatologiaTabla';
...
export const OrdenesPatologia = ({ datosEmergencia, session }: any) => {
    ...
    const updateOrdenesPatologiaClinica = useEmergenciaDatosStore((state: any) => state.updateOrdenesPatologiaClinica);
    ...
    const fetchPatologiaClinica = async () => {
        try {
            ...
            setIsLoading(true);
            const response = await getData(`${process.env.apijimmynew}/FactCatalogoServicios/factaCatalogoServicioByIdPuntoCargaAndFormaPago/2/${datosEmergencia?.idFormaPago}`);
    ...
    const crearNuevaReceta = async () => {
        ...
        try {
            ...
            const updatedOrdenes = await updateOrdenesPatologiaClinica(
    ...
    return (
        <>
            ...
            <div className="bg-white rounded-md shadow-sm p-4">
                ...
                <OrdenesPatologiaTablaRecetasCabecera datosEmergencia={datosEmergencia} handleOpenMenu={handleOpenMenu} />
            </div>

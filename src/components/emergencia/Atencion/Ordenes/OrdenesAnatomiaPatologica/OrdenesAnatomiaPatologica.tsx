...
import { OrdenesAnatomiaPatologicaTabla } from './OrdenesAnatomiaPatologicaTabla';
import { OrdenesAnatomiaPatologicaRecetasCabecera } from './OrdenesAnatomiaPatologicaRecetasCabecera';

export const OrdenesAnatomiaPatologica = ({ datosEmergencia, session }: any) => {
    ...
    const updateordenesAnatomiaPatologica = useEmergenciaDatosStore((state: any) => state.updateordenesAnatomiaPatologica);
    ...
    const fetchAnatomiaPatologica = async () => {
        try {
            ...
            setIsLoading(true);
            const response = await getData(`${process.env.apijimmynew}/FactCatalogoServicios/factaCatalogoServicioByIdPuntoCargaAndFormaPago/3/${datosEmergencia?.idFormaPago}`);
    ...
    const FormLaboratorio: SubmitHandler<any> = async (data: any) => {
        ...
        createordenesAnatomiaPatologica(datosServicios)
    ...
    const crearNuevaReceta = async () => {
        ...
        try {
            ...
            const updatedOrdenes = await updateordenesAnatomiaPatologica(

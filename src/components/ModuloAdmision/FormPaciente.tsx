...
export const FormPaciente = ({ usuario }: any) => {
    ...
    const handleKeyDown = (event: any) => {
        if (event.key === 'Enter') {
            event.preventDefault(); // Evitar que el form haga submit automático
            buscar_px(); // Ejecuta buscar cuando presiones Enter
        }
    };
            ...
            <form onSubmit={handleSubmit(onSubmit)} onKeyDown={handleKeyDown}>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                    ...
                    <div>
                        <select
                            {...register('tipo_doc')}
                            onChange={tipoDocChange} className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500`}>
                    ...
                    <div className='col-span-1 sm:col-span-2 md:col-span-4 grid grid-cols-1 md:grid-cols-4 gap-3'>
                        ...
                        <div className='col-span-2 md:col-span-3 grid grid-cols-1 sm:grid-cols-2 gap-6'>
                            <InputWithHeader label="Email" deshabilitado={false} {...register('email')} />
                            <InputWithHeader label="Nombre Padre" deshabilitado={false} {...register('nom_pad')} />
                        </div>
                    </div>
                    <div className='col-span-1 sm:col-span-2 md:col-span-4 grid grid-cols-1 md:grid-cols-4 gap-3'>
                        <InputWithHeader label="Num. Hijo" deshabilitado={false} {...register('num_hijo')} />
                        <InputWithHeader label="Observaciones" deshabilitado={false} {...register('observacion')} />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2  gap-3">
                    <div className='col-span-1  md:col-span-2  bg-gray-100 p-2'>
                        <span className='font-semibold'>Datos de la Madre o Tutor</span>
                    </div>
                    <div>
                        <span className=''>
                            Tipo Doc.
                        </span>
                        <select {...register('tipo_doc_tutor')} onChange={tipoDocTutoChange} className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500`}>
                            {tipoDocTuto && tipoDocTuto.map((td: any) => (
                                <option key={td.idDocIdentidad} value={td.idDocIdentidad}>
                                    {td.descripcion}
                                </option>
                            ))}
                    ...
                    <div className='col-span-1 grid grid-cols-2 gap-2'>
                        <div className="flex flex-col">
                            <label className="mb-1 text-gray-700">Num. Documento </label>
                            <input
                                type="number"
                                className="w-full px-3 py-2 border border-gray-300 rounded-r-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                placeholder=""
                                ...
                                {...register('num_doc_tuto')}
                                onKeyDown={handleKeyPress}
                                onChange={(e) => {
                                    const value = e.target.value;
                                    if (value.length > maxLengthTutor) {
                                        e.target.value = value.slice(0, maxLengthTutor);
                                    }
                                }}
                            />
                        </div>
                    ...
                    <InputWithHeader label="Primer Nombre" deshabilitado={false} {...register('prim_nom_tutor')} />
                    <InputWithHeader label="Segundo Nombre" deshabilitado={false} {...register('seg_nom_tutor')} />
                    <InputWithHeader label="Apellido Paterno" deshabilitado={false} {...register('ape_pat_tutor')} />
                    <InputWithHeader label="Apellido Materno" deshabilitado={false} {...register('ape_mat_tutor')} />
                </div>
